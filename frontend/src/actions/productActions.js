...
export const updateProduct = (product) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `http://localhost:8080/api/admin/products/${product._id}`,
      product,
      config
    )
...
export const createProductReview = (productId, review) => async (
  ...
  try {
    ...
    await axios.post(`http://localhost:8080/api/products/${productId}/reviews`, review, config)
...
export const listTopProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:8080/api/productss/top`)
